                ...
                <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white dark:bg-slate-800 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="amount"
                                    class="block dark:text-gray-400 text-sm font-medium text-gray-700">Amount</label>
                                <input type="number" name="amount" id="amount" autocomplete="amount"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="status"
                                    class="block text-sm dark:text-gray-400 font-medium text-gray-700">Status</label>
